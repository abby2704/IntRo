                ...
                if(is.list(lista1)){
                        if(length(lista1)==3){
                                if(!all(unique(c(sapply(lista1, dim))) %in% c(50,5))){
                                        warning("Ejercicio 1: La dimension de los data.frame no son correctas.")
                                }
                                if(!all(unique(c(sapply(lista1, colnames))) == names(datasets::iris))){
                                        warning("Ejercicio 1: Las variables de alguno de los data.frame no son correctas.")
                                }
                                if(!all(c("setosa","versicolor", "virginica") == tolower(names(lista1)))){
                                        warning("Ejercicio 1: El nombre de las entradas de lista no son correctos.")
                                }
                                ...
                                warning("Ejercicio 1: El largo de la lista no es correcto.")
                                base[[1]] <- 0
                        }
                } else{
                        warning("Ejercicio 1: El objeto 'lista1' no es de tipo lista.")
                        base[[1]] <- 0
                }
        }
                ...
                if(is.list(lista2)){
                        if(length(lista2)==6){
                                if(!all(unique(c(sapply(lista2[1:3], dim))) %in% c(50,5))){
                                        warning("Ejercicio 2: La dimension de los data.frame no son correctas.")
                                }
                                if(!all(unique(c(sapply(lista2[1:3], colnames))) == names(datasets::iris))){
                                        warning("Ejercicio 2: Las variables de alguno de los data.frame no son correctas.")
                                }
                                ...
                                warning("Ejercicio 2: El largo de la lista no es correcto.")
                                base[[2]] <- 0
                        }
                } else{
                        warning("Ejercicio 2: El objeto 'lista2' debe ser de tipo 'list'.")
                        base[[2]] <- 0
                }
        }
                ...
                if(is.list(lista3)){
                        if(length(lista3)==4){
                                if(!all(lista3[[1]]==c(0:10))){
                                        warning("Ejercicio 3: La secuencia del primer vector no es correcta.")
                                }
                                if(!all(lista3[[2]]==c(10:20))){
                                        warning("Ejercicio 3: La secuencia del segundo vector no es correcta.")
                                }
                                if(!all(lista3[[3]]==c(30:40))){
                                        warning("Ejercicio 3: La secuencia del tercer vector no es correcta.")
                                }
                                if(!all(lista3[[4]]==c(40:50))){
                                        warning("Ejercicio 3: La secuencia del cuarto vector no es correcta.")
                                }
                 ...
                 if(is.list(lista5)){
                         if(length(lista5)==11){
                                 if(!all(unlist(lista5)==c(20:30))){
                                         warning("Ejercicio 5: Alguno de los promedios no son correctos.")
                                 }
                                 base[[5]] <- ifelse(all(unlist(lista5)==c(20:30)), 1, 0)
                         }else{
                                 warning("Ejercicio 5: El largo de la lista no es correcto.")
                                 base[[5]] <- 0
                         }
                 } else{
                 ...
                 if(is.list(lista6)){
                         if(length(lista6)==1){
                                 if(sum(dim(lista6[[1]]))!=8){
                                         warning("Ejercicio 6: La dimension del objeto guardado no es correcta.")
                                 }
                                 if(!all(lista6[[1]][,1]==c("ARG", "BRA", "URY"))){
                                         warning("Ejercicio 6: El objeto guardado no es correcto.")
                                 }
                                 base[[6]] <- ifelse(sum(dim(lista6[[1]]))==8 &&
                                                             all(lista6[[1]][,1]==c("ARG", "BRA", "URY")), 1, 0)
                         }else{
                                 warning("Ejercicio 6: El largo de la lista no es correcto.")
                                 base[[6]] <- 0
                         }
                 } else{
